...
public class RatingController {
    ...
    public ResponseEntity<?> addRating(@PathVariable Long universityId,
                                       @RequestBody RatingDto ratingDto) {
        try {
            ratingService.addRating(ratingDto.getUserId(), universityId, ratingDto.getRating());
    ...
    public ResponseEntity<?> getAverageRating(@PathVariable Long universityId) {
        try {
    ...
    @ResponseBody
    public ResponseEntity<Boolean> hasUserVotedForUniversity(@RequestParam Long userId, @PathVariable Long universityId) {
    ...
    public ResponseEntity<?> checkVoteStatus(@PathVariable Long universityId,
    ...
    public ResponseEntity<?> removeRating(@PathVariable Long universityId,
                                          @RequestParam Long userId) {
        try {
            ...
            return ResponseEntity.badRequest().body(Map.of("error", "Rating not found"));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getUserRating(@PathVariable Long universityId,
                                           @RequestParam Long userId) {
        try {
...
//    тест
@GetMapping("/ratings")
public ResponseEntity<List<Map<String, Object>>> getAllUniversityRatings() {
    ...
    public Map<String, Object> broadcastRatingUpdate(RatingDto ratingDto) {
